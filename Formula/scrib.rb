class Scrib < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/solanyn/mono/releases/download/scrib%2Fv0.1.0/scrib-darwin-arm64"
      sha256 "6259f53a0015291f631af12c21893723669cbfade584e5c5eaa4d3a50466bef5"
    end
    on_intel do
      url "https://github.com/solanyn/mono/releases/download/scrib%2Fv0.1.0/scrib-darwin-amd64"
